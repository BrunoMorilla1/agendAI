...
public class ManipuladorExcecaoGlobal {
    ...
    public ResponseEntity<RespostaErro> tratarTarefaNaoEncontrada(TarefaNaoEncontradaException e){
        log.error("Tarefa não encontrada: {}", e.getMessage());

        RespostaErro errorResponse = RespostaErro.builder()
    ...
    public ResponseEntity<RespostaErro> tratarErrosDeValidacao(MethodArgumentNotValidException e){
    ...
    public ResponseEntity<RespostaErro> tratarExcecaoGenerica(Exception e){
